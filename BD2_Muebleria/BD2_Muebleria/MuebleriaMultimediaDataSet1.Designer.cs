...
namespace BD2_Muebleria {
    ...
    public partial class MuebleriaMultimediaDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/MuebleriaMultimediaDataSet1.xsd";
...
namespace BD2_Muebleria.MuebleriaMultimediaDataSetTableAdapters {
    ...
    public partial class CategoriaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [schema].[Categoria] WHERE (([idCategoria] = @Original_idCategoria) A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [schema].[Categoria] ([nombre]) VALUES (@nombre);\r\nSELECT idCategoria" +
                ", nombre FROM [schema].Categoria WHERE (idCategoria = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [schema].[Categoria] SET [nombre] = @nombre WHERE (([idCategoria] = @Origi" +
                "nal_idCategoria) AND ([nombre] = @Original_nombre));\r\nSELECT idCategoria, nombre" +
                " FROM [schema].Categoria WHERE (idCategoria = @idCategoria)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BD2_Muebleria.Properties.Settings.Default.MuebleriaMultimediaConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCategoria, nombre FROM [schema].Categoria";
    ...
    public partial class InventarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [schema].[Inventario] ([stock]) VALUES (@stock)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT fk_idMueble, stock FROM [schema].Inventario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class MaterialTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [schema].[Material] WHERE (([idMaterial] = @Original_idMaterial) AND " +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [schema].[Material] ([nombre]) VALUES (@nombre);\r\nSELECT idMaterial, " +
                "nombre FROM [schema].Material WHERE (idMaterial = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [schema].[Material] SET [nombre] = @nombre WHERE (([idMaterial] = @Origina" +
                "l_idMaterial) AND ([nombre] = @Original_nombre));\r\nSELECT idMaterial, nombre FRO" +
                "M [schema].Material WHERE (idMaterial = @idMaterial)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT idMaterial, nombre FROM [schema].Material";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class MuebleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [schema].[Mueble] ([color], [precio], [cuidados], [imagen], [fk_idTipoMueble], [fk_idCategoria], [fk_idMaterial]) VALUES (@color, @precio, @cuidados, @imagen, @fk_idTipoMueble, @fk_idCategoria, @fk_idMaterial);
SELECT idMueble, color, precio, cuidados, imagen, fk_idTipoMueble, fk_idCategoria, fk_idMaterial FROM [schema].Mueble WHERE (idMueble = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [schema].[Mueble] SET [color] = @color, [precio] = @precio, [cuidados] = @cuidados, [imagen] = @imagen, [fk_idTipoMueble] = @fk_idTipoMueble, [fk_idCategoria] = @fk_idCategoria, [fk_idMaterial] = @fk_idMaterial WHERE (([idMueble] = @Original_idMueble) AND ([color] = @Original_color) AND ([precio] = @Original_precio) AND ([cuidados] = @Original_cuidados) AND ((@IsNull_fk_idTipoMueble = 1 AND [fk_idTipoMueble] IS NULL) OR ([fk_idTipoMueble] = @Original_fk_idTipoMueble)) AND ((@IsNull_fk_idCategoria = 1 AND [fk_idCategoria] IS NULL) OR ([fk_idCategoria] = @Original_fk_idCategoria)) AND ((@IsNull_fk_idMaterial = 1 AND [fk_idMaterial] IS NULL) OR ([fk_idMaterial] = @Original_fk_idMaterial)));
SELECT idMueble, color, precio, cuidados, imagen, fk_idTipoMueble, fk_idCategoria, fk_idMaterial FROM [schema].Mueble WHERE (idMueble = @idMueble)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idMueble, color, precio, cuidados, imagen, fk_idTipoMueble, fk_idCategoria" +
                ", fk_idMaterial FROM [schema].Mueble";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class TipoMuebleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [schema].[TipoMueble] WHERE (([idMueble] = @Original_idMueble) AND ([" +
                "nombre] = @Original_nombre))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_idMueble", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "idMueble", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [schema].[TipoMueble] ([nombre]) VALUES (@nombre);\r\nSELECT idMueble, " +
                "nombre FROM [schema].TipoMueble WHERE (idMueble = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [schema].[TipoMueble] SET [nombre] = @nombre WHERE (([idMueble] = @Origina" +
                "l_idMueble) AND ([nombre] = @Original_nombre));\r\nSELECT idMueble, nombre FROM [s" +
                "chema].TipoMueble WHERE (idMueble = @idMueble)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_idMueble", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "idMueble", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_nombre", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "nombre", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT idMueble, nombre FROM [schema].TipoMueble";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
